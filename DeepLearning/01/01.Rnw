...
\begin{overlayarea}{\textwidth}{\textheight}
    \only<1>{\includegraphics[width=\textwidth]{plots/bird1.pdf}}
    \only<2>{\includegraphics[width=\textwidth]{plots/bird2.pdf}}
    \only<3>{\includegraphics[width=\textwidth]{plots/bird3.pdf}}
    \only<4>{\includegraphics[width=\textwidth]{plots/bird4.pdf}}
\end{overlayarea}
