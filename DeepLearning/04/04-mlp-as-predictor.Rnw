...
\begin{itemize}
\item A single hidden layer network is composed of a \textbf{hidden layer} having a set of neuron. 

\item Each neuron located in the hidden layer performs a 2-step computation.
...
\begin{frame} {Single Hidden Layer Networks: Example}
  ...
  \begin{figure}
    \centering
      ...
      \only<2>{\scalebox{.8}{\includegraphics{plots/1.png}}}
      ...
      \only<6>{\scalebox{.8}{\includegraphics{plots/singlelay_6.png}}}
  \end{figure}
  \begin{figure}
    \centering
  \end{figure}
...
\small{Forward pass through the shallow neural network.}
  \begin{figure}
    \centering
    \only<1>{\scalebox{.8}{\includegraphics{plots/singlelay_7.png}}}
    \only<2>{\scalebox{.8}{\includegraphics{plots/singlelay_8.png}}}
    \only<3>{\scalebox{.8}{\includegraphics{plots/singlelay_9.png}}}
  \end{figure}
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
