...
class InterfaceTypeComposer {
  ...
  getField(fieldName) {
    ...
    if (typeof field === 'string' || (0, _ObjectTypeComposer.isComposeOutputType)(field) || Array.isArray(field)) {
      return {
        type: field
      };
    }
  ...
  getFieldArg(fieldName, argName) {
    ...
    if (typeof arg === 'string' || (0, _ObjectTypeComposer.isComposeOutputType)(arg) || Array.isArray(arg)) {
      return {
        type: arg
      };
    }
  ...
  getFieldArgTC(fieldName, argName) {
    ...
    if (tc instanceof _ObjectTypeComposer.ObjectTypeComposer || tc instanceof InterfaceTypeComposer || tc instanceof _UnionTypeComposer.UnionTypeComposer) {
    ...
    if (isAsyncRuntime) {
      ...
      function () {
        var _ref = _asyncToGenerator(function* (value, context, info) {
          for (var _i = 0, _fastEntries = fastEntries; _i < _fastEntries.length; _i++) {
            const _fastEntries$_i = _slicedToArray(_fastEntries[_i], 2),
      ...
      resolveType = (value, context, info) => {
        for (var _i2 = 0, _fastEntries2 = fastEntries; _i2 < _fastEntries2.length; _i2++) {
          const _fastEntries2$_i = _slicedToArray(_fastEntries2[_i2], 2),
